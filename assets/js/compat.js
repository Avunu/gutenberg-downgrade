...
// PHP expects from the client and what the Gutenberg 11.9 bundles provide.
//
...
(function () {
	...
	// this for every server-registered block-bindings source. 11.9 predates
	// block bindings; a no-op keeps the inline script from throwing.
	if (typeof wp.blocks.registerBlockBindingsSource !== "function") {
		wp.blocks.registerBlockBindingsSource = function () {};
	}

	// Blocks the 11.9 client registers but that cannot work on current core
